...
<div id="fw_container">
	...
	<div id="fw_subcontainer">
		...
		<!-- submenu menu -->
			...
			<div class="fw_subselected collapse in" id="sub1">
				<ul>
					<li><a href="${pageContext.request.contextPath}/srm/storeNotice">자유게시판</a></li>
				</ul>
			</div>
	...
	<div id="fw_mainwrap">
		...
		<div id="fw_main">
			...
			<form action="./storeNoticeUpdate" method="post" id="frm">
						...
						<tr>
								<td id="textarea" colspan="2">
										<div class="eb_textarea">
											<textarea id="eb_contents" name="contents" draggable="false">${view.contents}</textarea>
