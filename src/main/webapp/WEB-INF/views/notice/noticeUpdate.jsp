...
<link href="${url}/resources/css/notice/noticeUpdate.css"
	rel="stylesheet">
						...
						<div class="notice_jk_tableBox">
							...
							<table class="table table-hover" id="notice_jk_table">
								<tr>
									<td>부서</td>
									<td>
										<input type="text" name="temp" id="part" value="${view.temp}" readonly="readonly">
									</td>
									<td>작성자</td>
								...
								<tr>
									...
									<td id="del">
										...
										<div class="del">${file.oriName}<input type="button" id="noticeFileDelete" class="noticeFileDelete" name="${file.fnum}" value="X" class="btn btn-default"></div>
									</td>
									</tr>
									</c:forEach>
								</tr>
