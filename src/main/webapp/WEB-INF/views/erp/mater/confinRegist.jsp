...
<div id="fw_container">
	...
	<div id="fw_mainwrap">
			<div id="fw_main">
				<div id="cr_icon"><img id="logoImg" src="${pageContext.request.contextPath}/resources/images/logo/smallLogo.png"></div>
			...
			<div id="fw_main_contents">
				...
				<!-- 등록 버튼 -->
					...
					<c:if test="${member.temp eq '영업/구매부'}">
						<button id="cr_insert" class="btn btn-default modal_btn" data-toggle="modal" data-target="#cr_modal">신규등록</button>
					</c:if>
					</div>
				<!-- 등록 버튼 끝 -->
